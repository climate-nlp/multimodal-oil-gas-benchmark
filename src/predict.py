...
def main():
    ...
    parser.add_argument('--train_file', type=str, default="Data/fb_video.train.jsonl")
    parser.add_argument('--test_file', type=str, default="Data/fb_video.test.jsonl")
    parser.add_argument('--videodir', type=str, default="Data/video/fb")
    parser.add_argument('--transcriptdir', type=str, default="Data/video_transcript/fb")
    parser.add_argument('--cachedir', type=str, default="Cache/yt")
    parser.add_argument('--min_transcript_segment_tokens', type=int, default=3)
    parser.add_argument('--prompt', type=str, default="Data/prompt/fb.txt")
